...
const RegisterForm: React.FC<RegisterFormProps> = ({ onSuccess }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        console.log("Registering with", { name, handle, email, password });
        onSuccess();
    };
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-gradient-to-r from-accent-start to-accent-end text-white font-bold py-3 rounded-lg hover:opacity-90 transition-opacity mt-6">
                Create Account
            </button>
        </form>
    );

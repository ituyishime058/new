      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-text-primary rounded-2xl w-full max-w-4xl h-[90vh] shadow-2xl flex flex-col relative overflow-hidden"
          >
            ...
            <div className="absolute top-4 right-4 w-48 h-32 bg-gray-900 rounded-lg border-2 border-gray-700 overflow-hidden">
            ...
            {/* Controls */}
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center space-x-6 bg-black/30 p-4 rounded-full backdrop-blur-md">
                <button className="p-3 bg-white/10 rounded-full text-white hover:bg-white/20 transition-colors">
                 ...
                 <button className="p-3 bg-white/10 rounded-full text-white hover:bg-white/20 transition-colors">
                    <Icon name="VideoCamera" className="w-6 h-6" />
                </button>
